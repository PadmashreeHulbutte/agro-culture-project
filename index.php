...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">freshfields &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">freshfields Fam<span>Vormir</span></p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About freshfields</b></span>
				freshfields is e-commerce trading platform for grains & grocerries...
			</p>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="farmer" name="category" value="2" checked>
				                            <label for="farmer">Farmer</label>
				                        </div>
										</div>
										<div class="3u 12u$(small)">
				                            <input type="radio" id="mediator" name="category" value="1.5" checked>
