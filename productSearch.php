		...
		<!-- Footer -->
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">Bahubali College Of Engineering<span>Shravanbelgola 573-135</span></p>
				</div>
				<div>
					<i class="fa fa-phone"></i>
					<p style="font-size:20px">9108811411</p>
				</div>
				<div>
					<i class="fa fa-envelope"></i>
					<p style="font-size:20px"><a href="nrrachana8@gmail.com" style="color:white">nrrachana8@gmail.com</a></p>
				</div>
			</div>

			<div class="footer-right">
				<p class="footer-company-about" style="color:white">
					<span style="font-size:20px"><b>About Zero's n One's</b></span>
					Zero's n ONe's is a team formed for hackathon 2021 from Bahubali College Of Engineering,Shravanbelgola
				</p>
